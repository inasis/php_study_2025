...
class PostController
{
    ...
    private function handleException(Exception $e): void
    {
        $statusCode = match (true) {
            ...
            $e instanceof \Egg\Exception\UnauthorizedException => 401,
            $e instanceof \Egg\Exception\ForbiddenException => 403,
            $e instanceof \Egg\Exception\NotFoundException => 404,
            $e instanceof \Egg\Exception\ValidationException => 422,
            default => 500
        };
