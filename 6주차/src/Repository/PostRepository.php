...
class PostRepository implements PostRepositoryInterface
{
    ...
    public function read(array $data): ?Post
    {
        try {
            ...
            throw new DatabaseException("Post 조회 중 데이터베이스 오류가 발생했습니다.", 500, $e);
        }
    }
    ...
    public function update(Post $post, array $data): Post
    {
        ...
        try {
            ...
            throw new DatabaseException("Post 수정 중 데이터베이스 오류가 발생했습니다.", 500, $e);
        }
    }
    ...
    public function delete(Post $post): void
    {
        try {
            ...
            throw new DatabaseException("Post 삭제 중 데이터베이스 오류가 발생했습니다.", 500, $e);
        }
    }
}